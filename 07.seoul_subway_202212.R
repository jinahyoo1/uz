...
#복적이라는 역은 생소하여 카카오맵에 복정이라는 역이 있는지 실제로 확인하였다.

#파생변수4. 총승하차승객수 tatal_passenger
...
#4.역별 일평균 전체승객수 상위10개 역을 막대그래프로 작성
